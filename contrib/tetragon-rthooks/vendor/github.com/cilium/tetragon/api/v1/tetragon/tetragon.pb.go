...
type KprobeArgument struct {
	...
	//	*KprobeArgument_Uint16Arg
	//	*KprobeArgument_Int16Arg
	//	*KprobeArgument_Uint8Arg
	//	*KprobeArgument_Int8Arg
...
func (x *KprobeArgument) GetUint16Arg() uint32 {
	if x != nil {
		if x, ok := x.Arg.(*KprobeArgument_Uint16Arg); ok {
			return x.Uint16Arg
		}
	}
	return 0
...
func (x *KprobeArgument) GetInt16Arg() int32 {
	if x != nil {
		if x, ok := x.Arg.(*KprobeArgument_Int16Arg); ok {
			return x.Int16Arg
		}
	}
	return 0
...
func (x *KprobeArgument) GetUint8Arg() uint32 {
	if x != nil {
		if x, ok := x.Arg.(*KprobeArgument_Uint8Arg); ok {
			return x.Uint8Arg
		}
	}
	return 0
...
func (x *KprobeArgument) GetInt8Arg() int32 {
	if x != nil {
		if x, ok := x.Arg.(*KprobeArgument_Int8Arg); ok {
			return x.Int8Arg
		}
	}
	return 0
...
type KprobeArgument_Uint16Arg struct {
	Uint16Arg uint32 `protobuf:"varint,32,opt,name=uint16_arg,json=uint16Arg,proto3,oneof"`
}

type KprobeArgument_Int16Arg struct {
	Int16Arg int32 `protobuf:"varint,33,opt,name=int16_arg,json=int16Arg,proto3,oneof"`
}

type KprobeArgument_Uint8Arg struct {
	Uint8Arg uint32 `protobuf:"varint,34,opt,name=uint8_arg,json=uint8Arg,proto3,oneof"`
}

type KprobeArgument_Int8Arg struct {
	Int8Arg int32 `protobuf:"varint,35,opt,name=int8_arg,json=int8Arg,proto3,oneof"`
}
...
func (*KprobeArgument_Uint16Arg) isKprobeArgument_Arg() {}

func (*KprobeArgument_Int16Arg) isKprobeArgument_Arg() {}

func (*KprobeArgument_Uint8Arg) isKprobeArgument_Arg() {}

func (*KprobeArgument_Int8Arg) isKprobeArgument_Arg() {}
...
var file_tetragon_tetragon_proto_rawDesc = []byte{
	...
	0x22, 0xe9, 0x0d, 0x0a, 0x0e, 0x4b, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x41, 0x72, 0x67, 0x75, 0x6d,
	...
	,
	...
	0x65, 0x73, 0x73, 0x52, 0x09, 0x61, 0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x73, 0x22, 0xff,
	0x02, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x55, 0x70, 0x72, 0x6f, 0x62, 0x65,
...
func file_tetragon_tetragon_proto_init() {
	...
	file_tetragon_tetragon_proto_msgTypes[32].OneofWrappers = []any{
		...
		(*KprobeArgument_Uint16Arg)(nil),
		(*KprobeArgument_Int16Arg)(nil),
		(*KprobeArgument_Uint8Arg)(nil),
		(*KprobeArgument_Int8Arg)(nil),
	}
